...
<script>
        ...
        //funzione che al click della freccia in giÃ¹ (img) attiverÃ  la funzione slideToggle() sulla navbar2 con una velocitÃ 
        //di 200ms e con relativa funzione eseguita al termine dello slide (cambia il riempimento della freccia in giÃ¹)
        ...
        function resulting(){
            ...
            xhttp.onreadystatechange = function (){
                ...
                if(xhttp.readyState === 4 && xhttp.status === 200){
                    ...
                    //prende il div che ospiterÃ  una serie di <a> con all'interno i titoli recuperati dall'oggetto x
